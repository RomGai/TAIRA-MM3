...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="可运行的 Clothing 统一评估流程：Agent3 -> Agent1/2 -> Agent4/5")
    ...
    parser.add_argument("--cache-dir", default="processed/cloth_cache")
    parser.add_argument("--output-dir", default="processed/cloth_unified_outputs")
    ...
    parser.add_argument("--collaborative-db-path", default="processed/cloth_collaborative_signal.db", help="协同信号SQLite存储路径")
